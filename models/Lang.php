...
class Lang extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'url' => Yii::t('app/lang', 'Url'),
            'local' => Yii::t('app/lang', 'Local'),
            'name' => Yii::t('app/lang', 'Name'),
            'default' => Yii::t('app/lang', 'Default'),
            'date_update' => Yii::t('app/lang', 'Date Update'),
            'date_create' => Yii::t('app/lang', 'Date Create'),
        ];
    }
